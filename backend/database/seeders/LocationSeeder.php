...
class LocationSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        foreach($this->locations as $location){
            $id_estado = DB::table('states')->insertGetId([
                'nombre' => $location['estado']
            ]);
            foreach($location['municipios'] as $municipio){
                $id_municipio = DB::table('municipalities')->insertGetId([
                    'state_id' => $id_estado,
                    'nombre' => $municipio['municipio']
                ]);

                foreach($municipio['parroquias'] as $parroquia){
                    $id_parroquia = DB::table('parishes')->insertGetId([
